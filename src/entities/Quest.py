...
class Quest(IQuest):
    ...
    @classmethod
    def from_dict(cls, dictOfAttrs) -> IQuest:
        return cls(dictOfAttrs["id"], dictOfAttrs["title"], dictOfAttrs["description"], dictOfAttrs["stats"], dictOfAttrs["skills"], dictOfAttrs["duration"], dictOfAttrs["conditions_for_success"], dictOfAttrs["status"], dictOfAttrs["tags"], dictOfAttrs["notes"], dictOfAttrs["start_time"])
